...
import os
from Agent_Class_M1 import clean_generated_code
import csv 
import networkx as nx
from IPython.display import display, Image

from Agent_Class_M1 import AgentState
from UnitTestGen_Agent_M1 import Create_Input_node, Create_TestCode_node, Check_TestCode_node, conditional_llm_check, Regenerate_code_node, Run_TestGen_node, conditional_error_check
from Translator_Agent_M1 import Translator_node
from Evaluator_Tool_M1 import Check_testing_status, conditional_merge_or_wait, UnitTest_Script_node, Run_test_node, Conditional_output, Output_node
from Regenerator_Agent_M1 import Check_error_type, Conditional_Error_Type, Regenerate_Function_node, Regenerate_Script_node
from Evaluation_M1 import  extract_input_code, eval_pipeline

class CodeTranslator_M2:
    ...
    def translator_architecture(self):
        ...
        #Architecture
        Translator.set_entry_point("Input_test_UTest")
        ...
        Translator.set_entry_point("Input_code_Translate")
        ...
        Translator.add_conditional_edges("Error_Analysis",Conditional_Error_Type,
                                        {
    ...
    def run_translator(self, code:str, max_iter:int):
    ...
    def Evaluate_pipeline(self, input_dir: str, output_dir: str, max_iter: int):
        ...
        for i, filename in enumerate(sorted(os.listdir(input_dir))):
            ...
            result_file = f"M2_results_{self.input_lang}_{self.output_lang}.csv"
            ...
            if filename.endswith(".py"):
                ...
                eval_pipeline(os.path.join(output_dir, file_name + ".java"), translated_code, self.input_lang, self.output_lang, result["num_iter"], result["num_iter"] == max_iter, result["code_status"], result["Translator_history"], result["UnitTest_history"])
...
java2py = CodeTranslator_M2("Python","Java")
