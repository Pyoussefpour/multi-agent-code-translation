...
```
    ...
    """, input_variables = ["input_language", "input_code", "target_language", "additional_instruction", "Code_analysis"]
)
...
def Translator_node(state: AgentState): 
    ...
    return {"output_code": clean_code, "Translator_status": "DONE", "Translator_history": state['Translator_history'] + Translator_history}